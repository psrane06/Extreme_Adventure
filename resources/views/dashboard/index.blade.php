        ...
        <x-card>
            ...
            <div class="row">
                <div class="col d-flex p-0">
                    <img class="rounded w-100 align-self-center" src="{{ asset('images/dashboard/dune_buggy.png') }}"
                        alt="">
                </div>
                ...
                <div class="col py-2">
                    ...
                    <p class="fw-bolder ms-3 text-opacity-50 text-secondary text-uppercase">BOOKINGS</p>
                </div>
                <div class="col">
                    <i class="bi bi-cash-coin align-middle fs-6"></i>
                    <span class="fs-4 p-2">{{ '110' }}</span>AED {{-- Value of tickets --}}
                    <p class="fw-bolder ms-3 text-opacity-50 text-secondary">Avg. value of each booking</p>
                </div>
            </div>
        </x-card>
        <x-card>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <p class="fw-bolder ms-4 text-opacity-50 text-secondary text-uppercase">Views</p>
                    <i class="bi bi-calendar2-check fs-5"></i>
                    <span class="fs-4 p-2">{{ '18' }}</span> {{-- Bookings --}}
                    <p class="fw-bolder ms-4 text-opacity-50 text-secondary text-uppercase">Bookings</p>
                </div>
            </div>
        </x-card>
    </div>
